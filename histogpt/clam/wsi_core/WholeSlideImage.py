...
class WholeSlideImage(object):
    ...
    def createPatches_bag_hdf5(self, save_path, patch_level=0, patch_size=512, step_size=512, save_coord=True, **kwargs):
    ...
    def _getPatchGenerator(self, cont, cont_idx, patch_level, save_path, patch_size=512, step_size=512, custom_downsample=1,
    ...
    @staticmethod
    def isInContours(cont_check_fn, pt, holes=None, patch_size=512):
        if cont_check_fn(pt):
    ...
    def process_contours(self, save_path, patch_level=0, patch_size=512, step_size=512, **kwargs):
    ...
    def process_contour(self, cont, contour_holes, patch_level, save_path, patch_size=512, step_size=512,
